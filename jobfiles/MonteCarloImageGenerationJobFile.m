...
DefaultJob.CaseName = '2015-03-07_diffusion_test';

% This is the path to the parent folder under which 
% the images and parameters will be saved
DefaultJob.ProjectRepository = '~/Desktop/diffusion_images_test';
...
% of particles.
% Units are pixels.
DefaultJob.Parameters.DiffusionStdDev = [0 5];
...
SegmentItem.Parameters.Noise.Std = 0.25;
