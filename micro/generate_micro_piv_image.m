function IMAGE = generate_micro_piv_image(X_PIX, Y_PIX, Z_PIX, ...
    ...
    pixel_size_microns, particle_volume_fraction, channel_depth_microns, ...
...
particle_concentration = 6 * particle_volume_fraction / ...
...
depth_of_field_microns = ...
    sqrt(4 * particle_concentration^(-2/3) - ...
    particle_diameter_microns^2 - 5.95 * wavelength_microns^2 / (4 * NA^2));
...
background_intensity = calculate_background_intensity(...
    channel_depth_microns, particle_volume_fraction, ...
