...
switch DIMS
    case 2
        ...
        if RUN_COMPILED
                ...
                % Generate the first image.
                image1 = generateParticleImage_mex(augmentedHeight, ...
                    augmentedWidth, X1, Y1, ...
                    particle_diameters, particleMaxIntensities_01);

                % Generate the second image
                image2 = generateParticleImage_mex(augmentedHeight, ...
                    augmentedWidth, X2, Y2, particle_diameters, ...
                    particleMaxIntensities_02);

        else
                % Generate the first image.
                image1 = generateParticleImage(augmentedHeight, ...
                    augmentedWidth, X1, Y1, ...
                    particle_diameters, particleMaxIntensities_01);

                % Generate the second image.
                image2 = generateParticleImage(augmentedHeight, ...
                    augmentedWidth, X2, Y2, particle_diameters, ...
                    particleMaxIntensities_02);
        end
